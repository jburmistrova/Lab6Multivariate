...
n <- 1
ccount <- 0
for (i in 1:ncol(wq.dat)) { #I'm so sorry for my horrendous for loop #Alan comment: I changed it to not be a specific number so the code can be more generalizable.
